...
function FinanceList() {
  const navigateTo = (sub: string) => {
    window.location.href = `/tax/finance/${sub}`
  }
  ...
  return (
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <button
          onClick={() => { window.location.href = '/tax/finance' }}
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/finance/loan-interest" />
        </div>
...
function MortgageLoanCalculator() {
  ...
  return (
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <button onClick={() => { window.location.href = '/tax/finance' }}
          className="flex items-center gap-2 text-gray-500 hover:text-gray-900 mb-4 sm:mb-6 transition-colors text-sm">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/finance/mortgage-loan" />
        </div>
...
function SavingsInterestCalculator() {
  ...
  return (
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <button onClick={() => { window.location.href = '/tax/finance' }} className="flex items-center gap-2 text-gray-500 hover:text-gray-900 mb-4 sm:mb-6 transition-colors text-sm">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/finance/savings-interest" />
        </div>
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/finance/early-repayment" />
        </div>
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/finance/auction-loan" />
        </div>
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/finance/estimated-income" />
        </div>
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/finance/loan-refinance" />
        </div>
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/finance/jeonse-guarantee" />
        </div>
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6 flex-wrap">
          ...
          <ShareButtons url="https://moajim.com/tax/finance/exchange-rate" />
        </div>
