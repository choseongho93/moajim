...
function ToolsList() {
  const navigateTo = (sub: string) => {
    window.location.href = `/tax/tools/${sub}`
  }
  ...
  return (
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <button
          onClick={() => { window.location.href = '/tax/tools' }}
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/tools/brokerage-fee" />
        </div>
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/tools/lawyer-fee" />
        </div>
...
function RentConversionCalculator() {
  ...
  return (
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <button onClick={() => { window.location.href = '/tax/tools' }} className="flex items-center gap-2 text-gray-500 hover:text-gray-900 mb-4 sm:mb-6 transition-colors text-sm">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/tools/rent-conversion" />
        </div>
