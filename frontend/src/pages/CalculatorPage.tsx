...
function CalculatorList() {
  const navigateTo = (sub: string) => {
    window.location.href = `/tax/calculator/${sub}`
  }
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/calculator/gift-tax" />
        </div>
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/calculator/inheritance-tax" />
        </div>
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/calculator/acquisition-tax" />
        </div>
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl p-6">
                ...
                <ul className="text-sm text-gray-700 leading-relaxed space-y-2">
                  ...
                  <li>부동산 증여 시 증여세 또한 발생할 수 있으니 <a href="/tax/calculator/gift-tax" target="_blank" rel="noopener noreferrer" className="text-[#F15F5F] font-medium hover:underline">증여세 계산기</a>를 함께 확인하세요.</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'registration' && (
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
            ...
            <button
              onClick={() => { window.location.href = '/tax/tools/lawyer-fee' }}
...
function HoldingTaxCalculator() {
  ...
  return (
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <button onClick={() => { window.location.href = '/tax/calculator' }} className="flex items-center gap-2 text-gray-500 hover:text-gray-900 mb-4 sm:mb-6 transition-colors text-sm">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/calculator/holding-tax" />
        </div>
    ...
    <div className="min-h-screen bg-white py-6 sm:py-12 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-4 sm:mb-6">
          ...
          <ShareButtons url="https://moajim.com/tax/calculator/capital-gains-tax" />
        </div>
