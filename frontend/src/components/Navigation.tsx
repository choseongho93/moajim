...
interface NavigationProps {
  ...
  onNavigate: (view: 'home' | 'calculator' | 'tools' | 'property-tax' | 'finance', subView?: string) => void
}
...
export default function Navigation({ activeView, activeSubView, onNavigate }: NavigationProps) {
  ...
  const handleNavigation = (view: 'home' | 'calculator' | 'tools' | 'property-tax' | 'finance', subView?: string) => {
